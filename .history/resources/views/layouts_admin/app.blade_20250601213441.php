...
<!-- Modal Hapus Riwayat -->
<div class="modal fade" id="riwayatDeleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content rounded">
            <div class="modal-header"><h5 class="modal-title">Konfirmasi</h5></div>
            <div class="modal-body">Apakah yakin ingin menghapus pelatihan ini dari riwayat?</div>
            <div class="modal-footer">
                <button class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                <form id="riwayatDeleteForm" method="POST">
                    @csrf
                    @method('DELETE')
...
<div id="riwayatPelatihan" class="content-section" style="display: none;">
 ...
 function setDeleteAction() {
    ...
    function submitToRiwayat() {
        ...
        function setRiwayatDeleteAction(id) {
        const form = document.getElementById('riwayatDeleteForm');
