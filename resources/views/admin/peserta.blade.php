                ...
                <tr>
                  ...
                  <td>
                      @if($pendaftaran->bukti_pembayaran)
                          <button type="button" class="btn btn-success btn-sm mb-1" data-bs-toggle="modal" data-bs-target="#buktiModal{{ $pendaftaran->id }}">
                              Lihat Bukti
                          </button>

                          <!-- Modal Bukti Pembayaran -->
                          <div class="modal fade" id="buktiModal{{ $pendaftaran->id }}" tabindex="-1" aria-labelledby="buktiModalLabel{{ $pendaftaran->id }}" aria-hidden="true">
                              <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body text-center">
                                          <img src="{{ asset('storage/' . $pendaftaran->bukti_pembayaran) }}" class="img-fluid" alt="Bukti Pembayaran">
                                      </div>
                                  </div>
                              </div>
                          </div>
                  ...
                  <td>
                      @if($pendaftaran->bukti_pembayaran)
                          <form action="{{ route('pendaftaran.validasi', $pendaftaran->id) }}" method="POST" class="d-flex flex-column gap-1">
                              @csrf
